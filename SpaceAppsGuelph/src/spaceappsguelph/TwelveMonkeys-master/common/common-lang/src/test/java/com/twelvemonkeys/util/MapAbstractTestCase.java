 ...
 */
public abstract class MapAbstractTestCase extends ObjectAbstractTestCase {
...
/*
     ...
     *
     * @return a {@link SetAbstractTestCase} instance for testing the map's entry set
     */
    /*
    ...
    */
    ...
    public class TestMapEntrySet extends SetAbstractTestCase {
        ...
        public void resetFull() {
            MapAbstractTestCase.this.resetFull();
            collection = map.entrySet();
            TestMapEntrySet.this.confirmed = MapAbstractTestCase.this.confirmed.entrySet();
        }

        public void resetEmpty() {
            MapAbstractTestCase.this.resetEmpty();
            collection = map.entrySet();
            TestMapEntrySet.this.confirmed = MapAbstractTestCase.this.confirmed.entrySet();
        }
        ...
        public void testMapEntrySetIteratorEntry() {
            ...
            while (it.hasNext()) {
                ...
                assertEquals(true, MapAbstractTestCase.this.map.containsKey(entry.getKey()));
                assertEquals(true, MapAbstractTestCase.this.map.containsValue(entry.getValue()));
                if (isGetStructuralModify() == false) {
                    assertEquals(MapAbstractTestCase.this.map.get(entry.getKey()), entry.getValue());
                }
                count++;
            }
        ...
        public void testMapEntrySetIteratorEntrySetValue() {
            ...
            assertEquals(true, MapAbstractTestCase.this.map.containsKey(entry1.getKey()));
            assertEquals(true, MapAbstractTestCase.this.map.containsValue(newValue1));
            assertEquals(newValue1, MapAbstractTestCase.this.map.get(entry1.getKey()));
            verifyAll();
            ...
            assertEquals(true, MapAbstractTestCase.this.map.containsKey(entry2.getKey()));
            assertEquals(true, MapAbstractTestCase.this.map.containsValue(newValue2));
            assertEquals(newValue2, MapAbstractTestCase.this.map.get(entry2.getKey()));
            verifyAll();
        }
        ...
        public void verifyAll() {
            super.verifyAll();
            MapAbstractTestCase.this.verifyAll();
        }
    }
     ...
     * that the map and the other collection views are still valid.
     *
     * @return a {@link SetAbstractTestCase} instance for testing the map's key set
     */
    /*
    ...
    */
    ...
    public class TestMapKeySet extends SetAbstractTestCase {
        public Object[] getFullElements() {
        ...
        public void resetEmpty() {
            ...
            TestMapKeySet.this.confirmed = MapAbstractTestCase.this.confirmed.keySet();
        }
     ...
     * that the map and the other collection views are still valid.
     *
     * @return a {@link CollectionAbstractTestCase} instance for testing the map's
     * values collection
     */
    /*
    ...
    */
    ...
    public class TestMapValues extends CollectionAbstractTestCase {
        public Object[] getFullElements() {
        ...
        public void resetFull() {
            ...
            TestMapValues.this.confirmed = MapAbstractTestCase.this.confirmed.values();
        }
